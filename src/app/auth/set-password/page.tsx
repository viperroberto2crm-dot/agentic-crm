...
export default function SetPasswordPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-4 bg-gray-50">
      ...
      >
        <div>
          <h1 className="text-xl font-semibold text-gray-900">Crea tu contraseña</h1>
          <p className="text-sm text-gray-500 mt-1">Elige una contraseña para acceder al CRM.</p>
        </div>
